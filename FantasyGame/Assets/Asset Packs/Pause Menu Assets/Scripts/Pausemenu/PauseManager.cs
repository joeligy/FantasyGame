...
namespace GreatArcStudios
{
    ...
    public class PauseManager : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Pause") && mainPanel.active == false)
            {
            ...
            else if(CrossPlatformInputManager.GetButtonDown("Pause") && mainPanel.active == true) {
                Time.timeScale = timeScale;
                pauseMenuActive = false;
                mainPanel.SetActive(false);
                vidPanel.SetActive(false);
        ...
        public void audioIn()
        {
            uiEventSystem.SetSelectedGameObject(defaultSelectedAudio);
        ...
        public void videoIn()
        {
            uiEventSystem.SetSelectedGameObject(defaultSelectedVideo);
        ...
        /// <summary>
        /// Change the fov using a float. The default should be 60.
        /// </summary>
